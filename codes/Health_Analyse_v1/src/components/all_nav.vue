  ...
  <el-menu default-active="1" class="el-menu-vertical-demo">
    ...
    <el-sub-menu index="2">
      ...
      <el-menu-item index="2-1" @click="handleClick('2-1')"
        >Sleep Data</el-menu-item
      >
      <el-menu-item index="2-2" @click="handleClick('2-2')"
        >Daily Step Data</el-menu-item
      >
      <el-menu-item index="2-3" @click="handleClick('2-3')"
        >Physical Activity Data</el-menu-item
      >
      <el-menu-item index="2-4" @click="handleClick('2-4')"
        >Dietary Data</el-menu-item
      >
      <el-menu-item index="2-5" @click="handleClick('2-5')"
        >Medication Data</el-menu-item
      >
    </el-sub-menu>
